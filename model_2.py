...
class ModelConfig:
    def __init__(
        self, 
        attract_funds: float =380_000_000_000,
        coupon_ofz_in=2.5,
        coupon_ofz_pd=13.74,
        face_ofz_in: float=10000,
        face_ofz_pd: float=1000,
        people_count: float=2_000_000,
        ndfl: float=13
    ):
...
# %%
from inflationpreparer import InflationRatePreparer
...
if __name__ == "__main__":
    ...
    # model_yd = FinancialModel()
    print(model_base.inflation)
    print("=== Доход по инструментам ===")
    print(model_base.summary)
    print("\n=== Нагрузка ОФЗ-ИН ===")
    print(model_base.government_ofz_in_l)
    print("\n=== Нагрузка ОФЗ-ПД ===")
    print(model_base.government_ofz_pd)